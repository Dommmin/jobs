                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium">
                                    {{ offer.specializations_array.join(', ') }}
                                </span>
                            </div>
...
interface Offer {
    ...
    work_type_array: string[];
    experience_array: string[];
    contract_array: string[];
    specialization_array: string[];
    tech_stack: string[];
    created_at: string;
}
