                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    v-for="work_type in offer.work_types_array"
                                    :key="work_type"
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    v-for="location in offer.locations_array"
                                    :key="location"
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    v-for="exp in offer.experiences_array"
                                    :key="exp"
                                ...
                                <span
                                    v-for="contract in offer.contracts_array"
                                    :key="contract"
...
interface Offer {
    ...
    work_types_array: string[];
    experiences_array: string[];
    contracts_array: string[];
    specializations_array: string[];
    created_at: string;
}
